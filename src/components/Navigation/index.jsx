 ...
 │   ├── Input.jsx`,
  ...
  },
  {
    ...
    content: [
      ...
      {
        b: "Примеры с популярными событиями:",
      },

      { p: " клик по кнопке (onClick)" },
    ...
    `,
      ...
      {
        p: "onMouseOver (Наведение курсора):",
      },
      {
